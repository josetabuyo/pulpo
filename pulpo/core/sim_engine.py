...
async def sim_receive(
    ...
    """
    from pulpo.core.db import log_message, mark_answered, log_outbound_message
    ...
    msg_type = "text"
    if audio_path:
        from pulpo.tools import transcription as transcription_mod
    ...
    if reply:
        ...
        from pulpo.graphs.nodes.summarize import accumulate as _accumulate
        _accumulate(
