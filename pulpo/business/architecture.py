"""
Business layer: radiografía viva del sistema.

Usado por interfaces/api/routers/architecture.py.
"""
import json
import logging
import subprocess
...
from pulpo.core.config import load_config, get_telegram_connections, get_wa_poll_interval
...
async def get_architecture(routes: list[dict], monitor_dir: Path, root_dir: Path) -> dict:
    ...
    return {
        ...
        "system": {
            "name": "Pulpo",
            "version_commit": _git_commit(root_dir),
