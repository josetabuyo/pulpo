...
async def buscar_posts_fb(state: LuganenseState) -> dict:
    ...
    """
    from pulpo.nodes import fetch_facebook, fb_cache
...
async def buscar_oficio(state: LuganenseState) -> dict:
    ...
    from pulpo.nodes import find_worker
...
async def notificar_oficio(state: LuganenseState) -> dict:
    ...
    from pulpo.nodes import notify_worker
    from pulpo.core.db import create_job
...
async def buscar_auspiciante(state: LuganenseState) -> dict:
    ...
    from pulpo.graphs import auspiciantes as auspiciantes_mod
