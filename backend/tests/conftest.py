...
Además escribe monitor/test_report_backend.json al final de cada corrida —
lo consume GET /api/architecture para la sección Arquitectura del dashboard.
"""
import json
import os
import time
...
# ─── Reporte vivo de tests (monitor/test_report_backend.json) ─────────────────

_REPORT_PATH = Path(__file__).parent.parent.parent / "monitor" / "test_report_backend.json"
...
def pytest_sessionfinish(session, exitstatus):
    ...
    # Escritura atómica: el backend puede estar leyendo el archivo
